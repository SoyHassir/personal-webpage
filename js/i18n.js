const TRANSLATIONS = {
  es: {
    ...
    "about-description": "Impulso la transformación de organizaciones y emprendedores conectando estrategia, datos e innovación para generar valor. Mi experiencia se nutre de la sinergia entre el rigor académico y la visión práctica del mundo empresarial.<br><br>Soy doctor en Planeación Estratégica y Dirección de Tecnología, y también en Economía y Empresa, con una maestría en Administración Estratégica y una base sólida como Administrador de Empresas. Actualmente, como profesor–investigador y analista de datos, acompaño de cerca los procesos de transformación y crecimiento.<br><br>Mi trayectoria profesional incluye roles como consultor, participación activa en proyectos de I+D+i, y una sólida producción académica con artículos, libros y capítulos centrados en estrategia, gestión organizacional, competitividad, turismo e innovación. He compartido estas perspectivas en eventos nacionales e internacionales como conferencista.<br>",
